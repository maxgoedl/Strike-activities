...
**[See REPORT.md](REPORT.md) for the summary-stats tables and time-series
charts**, rendered directly on GitHub. It's auto-generated by
`generate_report.py` — re-run that script (after `build_panel.py`) whenever
the underlying data changes, rather than editing REPORT.md by hand.
...
python3 generate_report.py           # regenerates both charts (with their
                                      # default countries) and writes
                                      # REPORT.md with markdown-formatted
